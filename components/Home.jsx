...
const Home = () => {
  return (
    <>
      ...
      <div className=' min-h-screen lg:mt-14 justify-center flex-col-reverse lg:flex-row flex lg:justify-between  gap-6 lg:gap-10 items-center md:px-16 sm:py-2 px-4 '>
        {/* <!--left part> */}
